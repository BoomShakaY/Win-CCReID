...
# -----------------No ranks------------------
# if opt.cloth:
#     command = 'python show_ranks.py --cloth --name ' + opt.name
#     os.system(command)
# elif opt.mix_cloth:
#     command = 'python show_ranks.py --mix_cloth --name ' + opt.name
#     os.system(command)
# else:
#     # standard
#     command = 'python show_ranks.py --name ' + opt.name
#     os.system(command)
